# -*- coding: utf-8 -*-
"""國立中山大學附屬國光高中-310039-吳定諴

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13cfutbbTzhq6n3XUaxDkw51SR3cdG7Mz
"""
...
# 假設 df 是你已有的 DataFrame
# df = pd.DataFrame(...)  # 請根據你的情況初始化 DataFrame
...
# 確保遊客數是字符串，然後清理數據
df_melted['遊客數'] = df_melted['遊客數'].astype(str).str.replace(' ', '').replace('', '0').astype(float).fillna(0).astype(int)
